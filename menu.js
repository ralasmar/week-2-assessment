...
const filterByProperty = (property, number, type) => {
    let filteredArr = [];
    if (type === `above`){
        filteredArr = foodArr.filter((item) => (item[property] > number))   // using square brackets to access a property of an object
